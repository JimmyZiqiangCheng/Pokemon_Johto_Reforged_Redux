...
- Hidden ability slots remain in the data. This restart keeps the wild
  post-processing hook deferred, so ordinary wild hidden-ability rolls remain
  deferred until that path is reintroduced safely.
