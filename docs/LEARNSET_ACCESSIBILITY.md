...
The active learnset source is `hg-engine-main/data/learnsets/learnsets.json`.
...
The Perfect Johto reference validation enforced these rules before import. In
this restart, parse `learnsets.json` and run `hg-engine-main/scripts/build_learnsets.py`
against temporary outputs before releasing Phase 2.
