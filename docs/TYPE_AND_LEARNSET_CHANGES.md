...
Perfect Johto Polished Crystal-priority Gen 1-2 changes imported in Phase 2:
...
Perfect Johto Gen 3-4 inspired changes imported in Phase 2:
...
- The original Perfect Johto type pass updated approved-scope level-up
  learnsets only. Machine, tutor, and egg move lists were not intentionally
...
For this restart, validate learnset JSON parsing and generation with
`hg-engine-main/scripts/build_learnsets.py` before releasing Phase 2.
