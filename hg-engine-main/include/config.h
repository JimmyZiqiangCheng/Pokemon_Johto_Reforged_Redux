...
// Johto Reforged phase 1 keeps vanilla save sizing for the first stable build.
...
// #define IMPLEMENT_PARTY_ITEM_USE_OVERRIDES

// Deferred from phase 1: the abandoned build saw first-wild-encounter freezes
// through the wild post-processing path.
// #define IMPLEMENT_WILD_MON_POSTPROCESSING_HOOK
